...
export const positions: Position[] = [
  {
    ...
    requirements: [
      'Strong communication skills, the one requirement we do not bend on',
    ...
    /*
     * A commission-only role cannot be advertised in British Columbia: the
     * Employment Standards Act requires at least minimum wage for all hours
     * worked, so the guarantee is stated alongside the commission rather than
     * left to the interview. Update the rate here if BC's minimum changes.
     */
    compensation:
      '$18.25/hour minimum earnings guarantee, plus commission. The commission structure is based on sales performance.',
  },
  {
    ...
    requirements: [
      ...
      'Resilient, because most calls end in a no and that is fine',
    ],
