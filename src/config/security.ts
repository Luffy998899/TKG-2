...
export const products: SecurityProduct[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'We work out the coverage from the actual building - which windows open, which doors are used, where the sightlines are - rather than fitting a fixed bundle to every property.',
    ],
    features: [
...
export const whyChoose: { title: string; body: string }[] = [
  {
    ...
    body: 'Not a reseller of whatever is cheapest this quarter. Brinks equipment, Brinks monitoring, fitted by us.',
  },
  {
