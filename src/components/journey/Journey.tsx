...
import { divisions, divisionPath, divisionCountWord } from '@/config/divisions';
        ...
        */}
        ...
        <div className="shell relative z-10 w-full pb-24 pt-[var(--header-h)] md:pb-28">
          ...
          <div
            ...
            className="max-w-[30ch] pb-8 md:absolute md:bottom-24 md:left-[var(--shell-x)] md:pb-0"
          >
            ...
            <h1
              ...
              className="mt-4 max-w-[14ch] font-display text-[clamp(2.75rem,13vw,3.75rem)] font-semibold leading-[0.98] tracking-[-0.04em] text-paper md:mt-5 md:text-display"
            >
              {site.name}
            </h1>
            {/*
              What the company IS, before the tagline says how it sounds.
              The tagline alone ("Scaling Businesses. Powering Growth.") reads
              as business-only, which left a first-time visitor to work out
              from eight service pages that the home side exists at all.
            */}
            <p className="mt-5 max-w-[28ch] font-display text-lead font-medium text-paper/90">
              {site.positioning}
            </p>
            <p className="mt-3 text-caption uppercase tracking-[0.14em] text-paper/55">
              {site.tagline}
            </p>
            ...
            */}
            ...
            <p className="mt-7 flex items-center gap-3 text-caption text-paper/60 motion-reduce:hidden">
              ...
              Scroll to travel through our {divisionCountWord}{' '}
              divisions
            </p>
 ...
 * same photographs as the 3D beats, as plain `next/image` cards.
 */
function StaticStrip() {
  return (
    <div data-journey-static className="on-night hidden bg-night">
      <div className="shell pb-16">
        {/* Counted from the config, like every other place the number appears -
            it went stale the first time a division was added. */}
        <p className="eyebrow mb-6">
          The {divisionCountWord} divisions
        </p>
        <ul className="grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-4">
